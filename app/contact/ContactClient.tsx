...
import { Zap, Mail, MessageSquare, Send, ShieldCheck, Clock, Layers } from 'lucide-react';
                ...
                <div className="container-custom">
                    <div className="grid lg:grid-cols-2 gap-12 items-start">
                        ...
                        <div className="space-y-12">
                            ...
                            <div className="grid sm:grid-cols-2 gap-6">
                                ...
                                >
                                    ...
                                    <h4 className="font-bold text-white mb-2 uppercase tracking-widest text-xs">Secure Transfer</h4>
                                    <p className="text-sm text-wl-accent font-black tracking-tight">HELLO@WLOPER.TECH</p>
                                </motion.div>
                                ...
                                >
                                    ...
                                    <h4 className="font-bold text-white mb-2 uppercase tracking-widest text-xs">Direct Link</h4>
                                    <p className="text-sm text-wl-accent font-black tracking-tight">@WLOPER_CORE</p>
                                </motion.div>
                            </div>
                        </div>
                        ...
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            className="glass-strong border border-white/5 rounded-[4rem] p-12 lg:p-20 relative"
                        >
                            <form className="space-y-12">
                                ...
                                <button
                                    type="submit"
                                    className="btn-primary w-full h-24 text-xl group relative shadow-2xl"
                                >
